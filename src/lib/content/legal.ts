...
export const privacyPolicy: LegalDocumentData = {
	...
	relatedLinks: [{ href: '/terms-and-conditions', label: 'Read the Terms and Conditions' }],
	sections: [
		{
			id: 'introduction',
		...
		},
		{
			...
			cards: [
				...
				},
				{
					...
					description: 'IP address, device and browser details, timestamps, and request metadata.'
				}
			]
		},
		{
