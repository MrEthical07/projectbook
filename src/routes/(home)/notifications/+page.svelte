<script lang="ts">
	...
	const markAllRead = () => {
		notifications = notifications.map((item) => (item.dismissed ? item : { ...item, read: true }));
	};
...
<svelte:head>
	...
	<meta name="description" content="View and manage your project notifications and updates." />
