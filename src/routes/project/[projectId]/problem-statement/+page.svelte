...
<svelte:head>
	<title>Problem Statement • {data.project?.name ?? "Project"} • ProjectBook</title>
	<meta name="description" content="Define and refine problem statements from research insights." />
