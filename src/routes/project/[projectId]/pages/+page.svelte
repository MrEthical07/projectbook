...
<svelte:head>
	<title>Pages • {data.project?.name ?? "Project"} • ProjectBook</title>
	<meta name="description" content="Create and organize project pages for documentation and collaboration." />
