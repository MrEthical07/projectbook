...
<svelte:head>
	<title>Resources • {data.project?.name ?? "Project"} • ProjectBook</title>
	<meta name="description" content="Store and manage project files, links, and supporting materials." />
