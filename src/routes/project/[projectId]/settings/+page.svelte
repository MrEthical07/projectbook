...
<svelte:head>
	<title>Settings • {data.project?.name ?? "Project"} • ProjectBook</title>
	<meta name="description" content="Configure project settings, governance, and operational preferences." />
