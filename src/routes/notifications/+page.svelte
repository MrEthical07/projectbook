			...
			<div class="grid gap-4 md:grid-cols-4">
				<div class="grid gap-2">
					...
					<Select.Root type="single" bind:value={filterRead}>
						<Select.Trigger>{filterRead}</Select.Trigger>
						<Select.Content>
				...
				<div class="grid gap-2">
					...
					<Select.Root type="single" bind:value={filterSource}>
						<Select.Trigger>{filterSource}</Select.Trigger>
						<Select.Content>
							<Select.Item value="All" label="All">All</Select.Item>
				...
				<div class="grid gap-2">
					...
					<Select.Root type="single" bind:value={filterProject}>
						<Select.Trigger>{filterProject}</Select.Trigger>
						<Select.Content>
				...
				<div class="grid gap-2">
					...
					<Select.Root type="single" bind:value={sortOrder}>
						<Select.Trigger>{sortOrder}</Select.Trigger>
						<Select.Content>
