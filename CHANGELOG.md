...
- Removed frontend `PROJECTBOOK_PERMISSION_CONTEXT_SECRET` dependency; frontend now consumes backend session-context payloads directly and clears legacy permission-context cookie state.
